...
@Component({
  selector: 'app-comites-bar',
  templateUrl: './comites-bar.component.html',
  styleUrls: ['./comites-bar.component.scss']
})
export class ComitesBarComponent implements OnInit {
  ...
  ngAfterViewInit() {
    let chart = am4core.create('chartComite', am4charts.XYChart);
