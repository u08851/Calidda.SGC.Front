...
@Component({
  selector: 'app-reuniones-bar',
  templateUrl: './reuniones-bar.component.html',
  styleUrls: ['./reuniones-bar.component.scss']
})
export class ReunionesBarComponent implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    // SERIES 1 - Reuniones convocadas
    let series1 = chart.series.push(new am4charts.ColumnSeries());
    series1.name = 'Reuniones convocadas';
    ...
    // SERIES 2 - Reuniones asistidas
    let series2 = chart.series.push(new am4charts.ColumnSeries());
    series2.name = 'Reuniones asistidas';
    ...
    // SERIES 3 - Reuniones faltantesw
    let series3 = chart.series.push(new am4charts.ColumnSeries());
    series3.name = 'Reuniones faltantes';
