...
@Component({
  selector: 'app-compromisos-bar',
  templateUrl: './compromisos-bar.component.html',
  styleUrls: ['./compromisos-bar.component.scss']
})
export class CompromisosBarComponent implements OnInit {
