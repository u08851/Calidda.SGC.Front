...
@Component({
  selector: 'app-votaciones-bar',
  templateUrl: './votaciones-bar.component.html',
  styleUrls: ['./votaciones-bar.component.scss']
})
export class VotacionesBarComponent implements OnInit {
  ...
  ngAfterViewInit() {
    let chart = am4core.create('chartVotaciones', am4charts.XYChart);
    ...
    // SERIES 1 - Comités Perteneciente
    let series1 = chart.series.push(new am4charts.ColumnSeries());
    series1.name = 'Comités Perteneciente';
    ...
    // SERIES 2 - Comités miembro titular
    let series2 = chart.series.push(new am4charts.ColumnSeries());
    series2.name = 'Comités miembro titular';
    ...
    gradient2.addColor(am4core.color('#00A34B99'));
    gradient2.addColor(am4core.color('#00A34B'));
    ...
    // SERIES 3 - Comités miembro suplente
    let series3 = chart.series.push(new am4charts.ColumnSeries());
    series3.name = 'Comités miembro suplente';
