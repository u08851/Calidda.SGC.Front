...
@Component({
  selector: 'app-actas-donut',
  templateUrl: './actas-donut.component.html',
  styleUrls: ['./actas-donut.component.scss']
})
export class ActasDonutComponent implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create("DonutchartActas", am4charts.PieChart);
    ...
    pieSeries1.colors.list = [
      am4core.color("#38BDF0"),
      am4core.color("#00A34B")
    ];
